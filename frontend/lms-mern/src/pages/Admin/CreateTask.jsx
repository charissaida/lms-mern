...
const CreateTask = () => {
  ...
  const deleteTask = async () => {
    try {
      await axiosInstance.delete(API_PATHS.TASKS.DELETE_TASK_BY_ID(taskId));
          ...
          <div className="form-card col-span-3">
            ...
            <div className="grid grid-cols-12 gap-4 mt-2">
              <div className="col-span-6 md:col-span-4">
                ...
                <SelectDropdown options={PRIORITY_DATA} value={taskData.priority} onChange={(option) => handleValueChange("priority", option.value)} placeholder="Select Priority" />
              </div>

              <div className="col-span-6 md:col-span-4">
                <label className="text-xs font-medium text-slate-600">Due Date</label>

                <input type="date" placeholder="Select Due Date" className="form-input" value={taskData.dueDate || ""} onChange={({ target }) => handleValueChange("dueDate", target.value)} />
              </div>
