...
const TodoListInput = ({ todoList, setTodoList }) => {
  ...
  // Function to handel adding an option
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-5 mt-4">
        <input type="text" placeholder="Enter Task" value={option} onChange={(e) => setOption(e.target.value)} className="w-full text-[13px] text-black outline-none bg-white border border-gray-100 px-3 py-2 rounded-md" />
